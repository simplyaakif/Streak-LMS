                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.sms-templates.update", [$smsTemplate->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $smsTemplate->title) }}" required>
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="sms_template" id="sms_template">{{ old('sms_template', $smsTemplate->sms_template) }}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $smsTemplate->active || old('active', 0) === 1 ? 'checked' : '' }}>
