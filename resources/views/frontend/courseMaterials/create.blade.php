        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.courseMaterial.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.course-materials.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="chapter_number" id="chapter_number" value="{{ old('chapter_number', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="chapter_name" id="chapter_name" value="{{ old('chapter_name', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="chapter_details" id="chapter_details">{!! old('chapter_details') !!}</textarea>
