    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.course-materials.update", [$courseMaterial->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="chapter_number" id="chapter_number" value="{{ old('chapter_number', $courseMaterial->chapter_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="chapter_name" id="chapter_name" value="{{ old('chapter_name', $courseMaterial->chapter_name) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="chapter_details" id="chapter_details">{!! old('chapter_details', $courseMaterial->chapter_details) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="content-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="position" id="position" value="{{ old('position', $courseMaterial->position) }}" step="1">
...
Dropzone.options.contentDropzone = {
    url: '{{ route('frontend.course-materials.storeMedia') }}',
    maxFilesize: 20, // MB
    addRemoveLinks: true,
    headers: {
