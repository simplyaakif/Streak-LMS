    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.recoveries.update", [$recovery->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="amount" id="amount" value="{{ old('amount', $recovery->amount) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            @foreach(App\Models\Recovery::IS_PAID_RADIO as $key => $label)
                                <div>
                                    <input type="radio" id="is_paid_{{ $key }}" name="is_paid" value="{{ $key }}" {{ old('is_paid', $recovery->is_paid) === (string) $key ? 'checked' : '' }}>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="paid_on" id="paid_on" value="{{ old('paid_on', $recovery->paid_on) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="reference_number" id="reference_number" value="{{ old('reference_number', $recovery->reference_number) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comments" id="comments">{{ old('comments', $recovery->comments) }}</textarea>
