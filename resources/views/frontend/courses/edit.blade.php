                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.courses.update", [$course->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="course_duration_id" id="course_duration_id" required>
                                @foreach($course_durations as $id => $course_duration)
                                    <option value="{{ $id }}" {{ (old('course_duration_id') ? old('course_duration_id') : $course->course_duration->id ?? '') == $id ? 'selected' : '' }}>{{ $course_duration }}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="fee" id="fee" value="{{ old('fee', $course->fee) }}" step="0.01" required>
                            @if($errors->has('fee'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('fee') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="course_content-dropzone">
                            </div>
