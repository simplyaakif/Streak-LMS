                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employees.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cnic_passport" id="cnic_passport" value="{{ old('cnic_passport', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="experience" id="experience" value="{{ old('experience', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="relegion" id="relegion" value="{{ old('relegion', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="basic_salary" id="basic_salary" value="{{ old('basic_salary', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="medical" id="medical" value="{{ old('medical', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="conveyance" id="conveyance" value="{{ old('conveyance', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_leave" id="deduction_leave" value="{{ old('deduction_leave', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_loan" id="deduction_loan" value="{{ old('deduction_loan', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_tax" id="deduction_tax" value="{{ old('deduction_tax', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_other" id="deduction_other" value="{{ old('deduction_other', '') }}" step="0.01">
