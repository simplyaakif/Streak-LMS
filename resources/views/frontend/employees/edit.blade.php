                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.employees.update", [$employee->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="dp-dropzone">
                            </div>
                            @if($errors->has('dp'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('dp') }}
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="city" id="city" value="{{ old('city', $employee->city) }}">
                            @if($errors->has('city'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('city') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="job_title" id="job_title" value="{{ old('job_title', $employee->job_title) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cnic_passport" id="cnic_passport" value="{{ old('cnic_passport', $employee->cnic_passport) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="qualification" id="qualification" value="{{ old('qualification', $employee->qualification) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="experience" id="experience" value="{{ old('experience', $employee->experience) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="relegion" id="relegion" value="{{ old('relegion', $employee->relegion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="documents_cv_experience-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="basic_salary" id="basic_salary" value="{{ old('basic_salary', $employee->basic_salary) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="medical" id="medical" value="{{ old('medical', $employee->medical) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="conveyance" id="conveyance" value="{{ old('conveyance', $employee->conveyance) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_leave" id="deduction_leave" value="{{ old('deduction_leave', $employee->deduction_leave) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_loan" id="deduction_loan" value="{{ old('deduction_loan', $employee->deduction_loan) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_tax" id="deduction_tax" value="{{ old('deduction_tax', $employee->deduction_tax) }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="deduction_other" id="deduction_other" value="{{ old('deduction_other', $employee->deduction_other) }}" step="0.01">
