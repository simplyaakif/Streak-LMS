                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.certificates.update", [$certificate->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="grade" id="grade" value="{{ old('grade', $certificate->grade) }}">
                            @if($errors->has('grade'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('grade') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="comment" id="comment">{{ old('comment', $certificate->comment) }}</textarea>
