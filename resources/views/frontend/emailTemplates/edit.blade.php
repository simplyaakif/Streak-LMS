                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.email-templates.update", [$emailTemplate->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $emailTemplate->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="email_message" id="email_message">{!! old('email_message', $emailTemplate->email_message) !!}</textarea>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="active" id="active" value="1" {{ $emailTemplate->active || old('active', 0) === 1 ? 'checked' : '' }}>
