                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.settings.update", [$setting->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="key" id="key" value="{{ old('key', $setting->key) }}">
                            @if($errors->has('key'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="value" id="value">{{ old('value', $setting->value) }}</textarea>
                            @if($errors->has('value'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('value') }}
                                </div>
