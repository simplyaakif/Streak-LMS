                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.student-statuses.update", [$studentStatus->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="start_date" id="start_date" value="{{ old('start_date', $studentStatus->start_date) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="end_date" id="end_date" value="{{ old('end_date', $studentStatus->end_date) }}">
