                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.payment-types.update", [$paymentType->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $paymentType->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="is_active" id="is_active" value="{{ old('is_active', $paymentType->is_active) }}">
