                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="place_of_birth" id="place_of_birth" value="{{ old('place_of_birth', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_language" id="first_language" value="{{ old('first_language', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="landline" id="landline" value="{{ old('landline', '') }}">
