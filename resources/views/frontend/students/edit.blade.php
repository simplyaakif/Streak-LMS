                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.students.update", [$student->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="place_of_birth" id="place_of_birth" value="{{ old('place_of_birth', $student->place_of_birth) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="first_language" id="first_language" value="{{ old('first_language', $student->first_language) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="date_of_birth" id="date_of_birth" value="{{ old('date_of_birth', $student->date_of_birth) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="cnic_passport" id="cnic_passport" value="{{ old('cnic_passport', $student->cnic_passport) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="mobile" id="mobile" value="{{ old('mobile', $student->mobile) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="landline" id="landline" value="{{ old('landline', $student->landline) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="admission_form-dropzone">
                            </div>
