    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.student-tasks.update", [$studentTask->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="task">{{ trans('cruds.studentTask.fields.task') }}</label>
                            <input class="form-control" type="text" name="task" id="task" value="{{ old('task', $studentTask->task) }}">
                            @if($errors->has('task'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="details" id="details">{!! old('details', $studentTask->details) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="assigned_by_id" id="assigned_by_id">
