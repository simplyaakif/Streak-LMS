                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.batches.update", [$batch->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="class_time" id="class_time" value="{{ old('class_time', $batch->class_time) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="strength" id="strength" value="{{ old('strength', $batch->strength) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="batch_content-dropzone">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="instructors[]" id="instructors" multiple required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="description" id="description">{!! old('description', $batch->description) !!}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="batch_thumbnail-dropzone">
                            </div>
...
Dropzone.options.batchContentDropzone = {
    url: '{{ route('frontend.batches.storeMedia') }}',
    maxFilesize: 100, // MB
    addRemoveLinks: true,
    headers: {
