                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.batches.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control timepicker" type="text" name="class_time" id="class_time" value="{{ old('class_time') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="strength" id="strength" value="{{ old('strength', '') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="instructors[]" id="instructors" multiple required>
                                @foreach($instructors as $id => $instructor)
                                    <option value="{{ $id }}" {{ in_array($id, old('instructors', [])) ? 'selected' : '' }}>{{ $instructor }}</option>
                                @endforeach
                            </select>
