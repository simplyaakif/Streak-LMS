    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.marketing-ads.update", [$marketingAd->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label for="title">{{ trans('cruds.marketingAd.fields.title') }}</label>
                            <input class="form-control" type="text" name="title" id="title" value="{{ old('title', $marketingAd->title) }}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="ad" id="ad">{!! old('ad', $marketingAd->ad) !!}</textarea>
                            @if($errors->has('ad'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ad') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="publish_at" id="publish_at" value="{{ old('publish_at', $marketingAd->publish_at) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="valid_till" id="valid_till" value="{{ old('valid_till', $marketingAd->valid_till) }}">
                        ...
                        <div class="form-group">
                            ...
                            <div class="needsclick dropzone" id="ad_design-dropzone">
                            </div>
...
<script>
    ...
    url: '{{ route('frontend.marketing-ads.storeMedia') }}',
    maxFilesize: 2, // MB
