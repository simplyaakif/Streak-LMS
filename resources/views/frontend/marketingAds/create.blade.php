        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header">
                    {{ trans('global.create') }} {{ trans('cruds.marketingAd.title_singular') }}
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.marketing-ads.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="ad" id="ad">{!! old('ad') !!}</textarea>
                            @if($errors->has('ad'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('ad') }}
                                </div>
