    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.test-answers.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="test_result_id">{{ trans('cruds.testAnswer.fields.test_result') }}</label>
                <select class="form-control select2 {{ $errors->has('test_result') ? 'is-invalid' : '' }}" name="test_result_id" id="test_result_id">
            ...
            <div class="form-group">
                <label for="question_id">{{ trans('cruds.testAnswer.fields.question') }}</label>
            ...
            <div class="form-group">
                <label for="option_id">{{ trans('cruds.testAnswer.fields.option') }}</label>
