...
@can('course_material_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.course-materials.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-CourseMaterial">
            <thead>
                <tr>
                    <th width="10">
...
@can('course_material_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.course-materials.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.course-materials.index') }}",
    columns: [
...
{ data: 'content', name: 'content', sortable: false, searchable: false },
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-CourseMaterial').DataTable(dtOverrideGlobals);
