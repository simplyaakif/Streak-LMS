    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.course-materials.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chapter_number') ? 'is-invalid' : '' }}" type="text" name="chapter_number" id="chapter_number" value="{{ old('chapter_number', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('chapter_name') ? 'is-invalid' : '' }}" type="text" name="chapter_name" id="chapter_name" value="{{ old('chapter_name', '') }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('chapter_details') ? 'is-invalid' : '' }}" name="chapter_details" id="chapter_details">{!! old('chapter_details') !!}</textarea>
