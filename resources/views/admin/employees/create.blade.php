    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.employees.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cnic_passport') ? 'is-invalid' : '' }}" type="text" name="cnic_passport" id="cnic_passport" value="{{ old('cnic_passport', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('relegion') ? 'is-invalid' : '' }}" type="text" name="relegion" id="relegion" value="{{ old('relegion', '') }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('earning_type') ? 'is-invalid' : '' }}" name="earning_type" id="earning_type">
                    ...
                    @foreach(App\Models\Employee::EARNING_TYPE_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('earning_type', '') === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('basic_salary') ? 'is-invalid' : '' }}" type="number" name="basic_salary" id="basic_salary" value="{{ old('basic_salary', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('medical') ? 'is-invalid' : '' }}" type="number" name="medical" id="medical" value="{{ old('medical', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('conveyance') ? 'is-invalid' : '' }}" type="number" name="conveyance" id="conveyance" value="{{ old('conveyance', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deduction_leave') ? 'is-invalid' : '' }}" type="number" name="deduction_leave" id="deduction_leave" value="{{ old('deduction_leave', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deduction_loan') ? 'is-invalid' : '' }}" type="number" name="deduction_loan" id="deduction_loan" value="{{ old('deduction_loan', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deduction_tax') ? 'is-invalid' : '' }}" type="number" name="deduction_tax" id="deduction_tax" value="{{ old('deduction_tax', '') }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('deduction_other') ? 'is-invalid' : '' }}" type="number" name="deduction_other" id="deduction_other" value="{{ old('deduction_other', '') }}" step="0.01">
