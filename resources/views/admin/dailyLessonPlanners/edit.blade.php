...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.daily-lesson-planners.update", [$dailyLessonPlanner->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('title') ? 'is-invalid' : '' }}" type="text" name="title" id="title" value="{{ old('title', $dailyLessonPlanner->title) }}">
                @if($errors->has('title'))
                    <div class="invalid-feedback">
                        {{ $errors->first('title') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('description') ? 'is-invalid' : '' }}" name="description" id="description">{!! old('description', $dailyLessonPlanner->description) !!}</textarea>
...
<script>
    ...
    url: '{{ route('admin.daily-lesson-planners.storeMedia') }}',
    maxFilesize: 20, // MB
    maxFiles: 1,
    addRemoveLinks: true,
    headers: {
