...
@can('daily_lesson_planner_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.daily-lesson-planners.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-DailyLessonPlanner">
            <thead>
                <tr>
                    <th width="10">
...
@can('daily_lesson_planner_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.daily-lesson-planners.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.daily-lesson-planners.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-DailyLessonPlanner').DataTable(dtOverrideGlobals);
