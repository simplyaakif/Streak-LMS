    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.batches.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control timepicker {{ $errors->has('class_time') ? 'is-invalid' : '' }}" type="text" name="class_time" id="class_time" value="{{ old('class_time') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('strength') ? 'is-invalid' : '' }}" type="number" name="strength" id="strength" value="{{ old('strength', '') }}" step="1">
