...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.recoveries.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Recovery::IS_PAID_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('is_paid') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="is_paid_{{ $key }}" name="is_paid" value="{{ $key }}" {{ old('is_paid', '') === (string) $key ? 'checked' : '' }}>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('paid_on') ? 'is-invalid' : '' }}" type="text" name="paid_on" id="paid_on" value="{{ old('paid_on') }}">
