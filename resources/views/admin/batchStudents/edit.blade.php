    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.batch-students.update", [$batchStudent->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('sessions_start_date') ? 'is-invalid' : '' }}" type="text" name="sessions_start_date" id="sessions_start_date" value="{{ old('sessions_start_date', $batchStudent->sessions_start_date) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('session_end_date') ? 'is-invalid' : '' }}" type="text" name="session_end_date" id="session_end_date" value="{{ old('session_end_date', $batchStudent->session_end_date) }}" required>
