...
@can('institution_calendar_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.institution-calendars.create') }}">
...
<div class="card">
    ...
    <div class="card-body">
        <table class=" table table-bordered table-striped table-hover ajaxTable datatable datatable-InstitutionCalendar">
            <thead>
                <tr>
                    <th width="10">
...
@can('institution_calendar_delete')
  ...
  let deleteButton = {
    ...
    url: "{{ route('admin.institution-calendars.massDestroy') }}",
...
@endcan
  ...
  let dtOverrideGlobals = {
    ...
    retrieve: true,
    aaSorting: [],
    ajax: "{{ route('admin.institution-calendars.index') }}",
    columns: [
...
{ data: 'actions', name: '{{ trans('global.actions') }}' }
  ...
  let table = $('.datatable-InstitutionCalendar').DataTable(dtOverrideGlobals);
