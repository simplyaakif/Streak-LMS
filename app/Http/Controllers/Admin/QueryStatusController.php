...
class QueryStatusController extends Controller
{
    public function index()
    {
        ...
        return view('admin.queryStatuses.index', compact('queryStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.queryStatuses.create');
    }
    ...
    public function store(StoreQueryStatusRequest $request)
    {
        ...
        return redirect()->route('admin.query-statuses.index');
    }
    ...
    public function edit(QueryStatus $queryStatus)
    {
        ...
        return view('admin.queryStatuses.edit', compact('queryStatus'));
    }
    ...
    public function show(QueryStatus $queryStatus)
    {
        ...
        return view('admin.queryStatuses.show', compact('queryStatus'));
    }
