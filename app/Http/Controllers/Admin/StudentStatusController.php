...
class StudentStatusController extends Controller
{
    public function index()
    {
        ...
        return view('admin.studentStatuses.index', compact('studentStatuses'));
    }
    ...
    public function create()
    {
        ...
        return view('admin.studentStatuses.create');
    }
    ...
    public function edit(StudentStatus $studentStatus)
    {
        ...
        return view('admin.studentStatuses.edit', compact('studentStatus'));
    }
    ...
    public function show(StudentStatus $studentStatus)
    {
        ...
        return view('admin.studentStatuses.show', compact('studentStatus'));
    }
