...
class BatchStudentsApiController extends Controller
{
    public function index()
    {
        abort_if(Gate::denies('batch_student_access'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new BatchStudentResource(BatchStudent::with(['batch', 'student', 'student_status'])->get());
    }
    ...
    public function show(BatchStudent $batchStudent)
    {
        ...
        return new BatchStudentResource($batchStudent->load(['batch', 'student', 'student_status']));
    }
