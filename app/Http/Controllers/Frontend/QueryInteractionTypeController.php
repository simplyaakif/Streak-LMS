...
class QueryInteractionTypeController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.queryInteractionTypes.index', compact('queryInteractionTypes'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.queryInteractionTypes.create');
    }
    ...
    public function store(StoreQueryInteractionTypeRequest $request)
    {
        ...
        return redirect()->route('frontend.query-interaction-types.index');
    }
    ...
    public function edit(QueryInteractionType $queryInteractionType)
    {
        ...
        return view('frontend.queryInteractionTypes.edit', compact('queryInteractionType'));
    }
    ...
    public function show(QueryInteractionType $queryInteractionType)
    {
        ...
        return view('frontend.queryInteractionTypes.show', compact('queryInteractionType'));
    }
