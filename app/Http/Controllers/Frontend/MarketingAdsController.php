...
class MarketingAdsController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('frontend.marketingAds.index', compact('marketingAds'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.marketingAds.create');
    }
    ...
    public function store(StoreMarketingAdRequest $request)
    {
        ...
        return redirect()->route('frontend.marketing-ads.index');
    }
    ...
    public function edit(MarketingAd $marketingAd)
    {
        ...
        return view('frontend.marketingAds.edit', compact('marketingAd'));
    }
    ...
    public function show(MarketingAd $marketingAd)
    {
        ...
        return view('frontend.marketingAds.show', compact('marketingAd'));
    }
