...
class StaffNotificationController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.staffNotifications.index', compact('staffNotifications'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.staffNotifications.create', compact('staff_members'));
    }
    ...
    public function store(StoreStaffNotificationRequest $request)
    {
        ...
        return redirect()->route('frontend.staff-notifications.index');
    }
    ...
    public function edit(StaffNotification $staffNotification)
    {
        ...
        return view('frontend.staffNotifications.edit', compact('staff_members', 'staffNotification'));
    }
    ...
    public function show(StaffNotification $staffNotification)
    {
        ...
        return view('frontend.staffNotifications.show', compact('staffNotification'));
    }
