...
class BatchNotificationsController extends Controller
{
    public function index()
    {
        ...
        return view('frontend.batchNotifications.index', compact('batchNotifications'));
    }
    ...
    public function create()
    {
        ...
        return view('frontend.batchNotifications.create', compact('batches'));
    }
    ...
    public function store(StoreBatchNotificationRequest $request)
    {
        ...
        return redirect()->route('frontend.batch-notifications.index');
    }
    ...
    public function edit(BatchNotification $batchNotification)
    {
        ...
        return view('frontend.batchNotifications.edit', compact('batches', 'batchNotification'));
    }
    ...
    public function show(BatchNotification $batchNotification)
    {
        ...
        return view('frontend.batchNotifications.show', compact('batchNotification'));
    }
